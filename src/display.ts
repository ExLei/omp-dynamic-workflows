import type { ExtensionContext, Theme } from "./omp-api.js";
 ...
 * plus their reported cost. Agents report usage while they run, so this is the
 * live counterpart to the run-level aggregate, which only lands when the run ends.
 */
