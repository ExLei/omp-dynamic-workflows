/**
 * Named OMP workflow subagent definitions (`agentType` registry).
 *
 * Definitions follow OMP's native discovery layout:
 * `.omp/agents/*.md` for the project and `~/.omp/agent/agents/*.md` for the
 * user. Project definitions win on name collisions. Frontmatter binds tools,
 * model, isolation, and the Markdown body prompt.
 */
...
/**
 * Load the agent registry once for a run. Project definitions win over user
