 ...
 * so it stays decoupled from the OMP SDK and remains unit-testable with plain
 * objects. `agent.ts` projects live registry models into this shape.
 */
...
/** Path to the model tiers JSON config file (~/.omp/workflows/model-tiers.json). */
